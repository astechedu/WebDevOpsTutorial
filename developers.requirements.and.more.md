...
Here is the list of Web App Development Trends to watch in 2020
   ...
   10. JavaScript Frameworks
   11. Internet of Things (IoT)               //https://youtu.be/313plfVUpB0?t=100
   12. Responsive Websites
   13. Push Notifications                    //https://youtu.be/yFLc5J2BG6A?t=329 (website: pushjs.org)
   14. Cyber Security
...
Details:----
   ...
   3. Data Structures and Algorithms. ...
                Website: https://www.programiz.com/dsa
...
* Front-End Web Development Road Map:
   ...
   1. HTML, CSS, Sass, LeSS, JavaScript & TypeScript        
   2. CSS & JavaScript Frameworks
        a) CSS Frameworks :              bootstrap, Ulkit, Semantic UI, Foundation, Bulma, Tailwind CSS, Spectre
        b) JavaScript Frameworks:    Angular, React, Vue.js, Ember.js, Meteor, Node.js, jQuery

   3. Version Control System
        a) GitHub, GitLab, AWS CodeCommit, Beanstalk, Apache Subversion

   4. Micro-Frontend

   5. Testing & Code Analysis Tools
           Unit Testing, Visual Regression Testing, Acceptance Tesing, Perfomance Testing, Integration Testing, 
           Accessibility Testing, End-to-end Testing, Cross-Browser Compatibility Testing
   ...
   7. Static Site Generator (SSG)
           Next.js, Gatsby, Hugo, GitBook, Jekyll, Eleventy, 
           Nuxt, Docsify, VuePress, Gridsome
...
platform provided by Amazon that includes a mixture of infrastructure as a service (IaaS), 
