...
This tutorial was verified with Node v14.2.0, npm v6.14.5, mongodb-community v4.2.6, express v4.17.1, and mongoose v5.9.17.
...
The server can be created in two ways: first is to use the built-in http module in Node; second is to make use of the Express.js framework.
...
Since you are done with the functionality you want from your API, it is time to create an interface for the client to interact with the API. To start out with the frontend of the todo app, you will use the create-react-app command to scaffold your app.
...
b6917d9101178228a35e65ac251b03
•
November 10, 2021
